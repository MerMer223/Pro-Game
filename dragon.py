...
run = True
redship = pygame.image.load("Pygame/images/reddragon.png")
yellowship = pygame.image.load("Pygame/images/bluedragon.png")
...
space = pygame.transform.scale(pygame.image.load("Pygame/images/sky.jpeg"),(WIDTH,HEIGHT))
