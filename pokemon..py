...
class Bin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("Pygame/images/pokeball.png")
...
class Nonrecycle(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("Pygame/images/rock.png")
        #self.image = pygame.transform.scale(self.image,(400,400))
        self.rect = self.image.get_rect()
images = ["Pygame/images/pikachu2.png","Pygame/images/mewtwo.png","Pygame/images/charizard.png"]
...
while run:
    ...
    if timeElapsed >= 60:
        ...
        changebackground("Pygame/images/field (2).jpeg")
